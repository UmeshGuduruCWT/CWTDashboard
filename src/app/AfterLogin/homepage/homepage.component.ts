...
export class HomepageComponent implements OnInit {
  ...
  constructor(private router : Router,public service : DashboardServiceService,public dashboard : DashboardComponent,) { }
  ...
  GetData(Region : string){
    ...
    this.service.HomeDetailsData(Region).subscribe(data =>{
      ...
      console.log(this.CurrentMonthVolume);
      this.CurrentMonthRecords = data.CurrentMonthRecords+"";
      console.log(this.CurrentMonthRecords);
